...
function find_stat(replier, msg) {
  if (msg.indexOf("!일대일 ") == 0) {
    var ovo = msg.split(" ");
    var url =
      "http://fifaonline4.nexon.com/datacenter/rank?strCharacterName=" + ovo[1];
    var doc = null;
  ...
  if (msg.indexOf("!이대이 ") == 0) {
    var ovo = msg.split(" ");
    var url =
      "http://fifaonline4.nexon.com/datacenter/rank_2vs?strCharacterName=" +
      ovo[1];
    var doc = null;
    doc = org.jsoup.Jsoup.connect(url).get();
    if (doc.text().includes("포함되어")) {
  ...
  if (msg.indexOf("!감모 ") == 0) {
    var ovo = msg.split(" ");
    var url =
      "http://fifaonline4.nexon.com/datacenter/rank_m?strCharacterName=" +
      ovo[1];
    var doc = null;
    doc = org.jsoup.Jsoup.connect(url).get();
    if (doc.text().includes("포함되어")) {
  ...
  if (msg.indexOf("!볼타격수 ") == 0) {
    var ovo = msg.split(" ");
    var url =
      "http://fifaonline4.nexon.com/datacenter/rank_volta?rtype=fw&strCharacterName=" +
      ovo[1];
    var doc = null;
    doc = org.jsoup.Jsoup.connect(url).get();
    if (doc.text().includes("포함되어")) {
  ...
  if (msg.indexOf("!볼타미드 ") == 0) {
    var ovo = msg.split(" ");
    var url =
      "http://fifaonline4.nexon.com/datacenter/rank_volta?rtype=mf&strCharacterName=" +
      ovo[1];
    var doc = null;
    doc = org.jsoup.Jsoup.connect(url).get();
    if (doc.text().includes("포함되어")) {
  ...
  if (msg.indexOf("!볼타수비 ") == 0) {
    var ovo = msg.split(" ");
    var url =
      "http://fifaonline4.nexon.com/datacenter/rank_volta?rtype=df&strCharacterName=" +
      ovo[1];
    var doc = null;
    doc = org.jsoup.Jsoup.connect(url).get();
    if (doc.text().includes("포함되어")) {
  ...
  if (msg.indexOf("!볼타전체 ") == 0) {
    var ovo = msg.split(" ");
    var url =
      "http://fifaonline4.nexon.com/datacenter/rank_volta?rtype=all&strCharacterName=" +
      ovo[1];
    var doc = null;
    doc = org.jsoup.Jsoup.connect(url).get();
    if (doc.text().includes("포함되어")) {
